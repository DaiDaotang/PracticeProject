...
var GetCompanyTeacherURL = "http://42.159.228.113:8081/BackCode_war/GetCompanyTeacherByCompanyIdServlet"
    , CreateNewProjectURL = "http://42.159.228.113:8081/BackCode_war/CreateProjectServlet";
...
layui.use(['form', 'jquery', 'layer', 'rate', 'table'], function () {
    ...
    if (item_id) {
        ...
        var GetTeamInfoURL = "http://42.159.228.113:8081/BackCode_war/GetProjectInformationServlet"
        $.ajax({
            type: "POST",
            url: GetTeamInfoURL,
            async: true,
