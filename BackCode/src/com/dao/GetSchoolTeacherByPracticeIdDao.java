...
public class GetSchoolTeacherByPracticeIdDao {
    public ArrayList<SchoolTeacherBean> GetSchoolTeacher(int practiceId)
    {
        ...
        try{
            ...
            String sql ="SELECT schoolteacherId,schoolteacherName,schoolTeacherSex FROM pracstrelation,schoolteacher WHERE practice id = ? AND pracstrelation.schoolTeacherId = schoolteacher.schoolTeacherId";
