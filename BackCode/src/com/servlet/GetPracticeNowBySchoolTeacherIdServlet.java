...
import com.dao.GetPracticeNowBySchoolTeacherIdDao;
...
@WebServlet(name = "GetPracticeNowBySchoolTeacherIdServlet")
public class GetPracticeNowBySchoolTeacherIdServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            GetPracticeNowBySchoolTeacherIdDao dao = new GetPracticeNowBySchoolTeacherIdDao();
