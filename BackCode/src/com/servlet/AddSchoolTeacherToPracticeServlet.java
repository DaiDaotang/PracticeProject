...
import com.dao.AddSchoolTeacherToPracticeDao;
...
public class AddSchoolTeacherToPracticeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            AddSchoolTeacherToPracticeDao dao = new AddSchoolTeacherToPracticeDao();
            int res = dao.addTeacher(reqBean);
            if (res == -1){
