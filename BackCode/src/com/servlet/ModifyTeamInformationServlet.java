...
import com.dao.ModifyTeamInformationDao;
...
@WebServlet(name = "ModifyTeamInformationServlet")
public class ModifyTeamInformationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ModifyTeamInformationDao dao = new ModifyTeamInformationDao();
            int i = dao.modifyTeam(reqBean);
            if (i == -1){
