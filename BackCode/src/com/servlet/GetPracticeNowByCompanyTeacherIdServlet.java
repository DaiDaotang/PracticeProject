...
import com.dao.GetPracticeNowByCompanyTeacherIdDao;
...
@WebServlet(name = "GetPracticeNowByCompanyTeacherIdServlet")
public class GetPracticeNowByCompanyTeacherIdServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            GetPracticeNowByCompanyTeacherIdDao dao = new GetPracticeNowByCompanyTeacherIdDao();
