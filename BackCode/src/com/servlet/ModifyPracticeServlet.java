...
import com.dao.ModifyPracticeDao;
...
@WebServlet(name = "ModifyPracticeServlet")
public class ModifyPracticeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ModifyPracticeDao dao = new ModifyPracticeDao();
            int res = dao.modifyPractice(reqBean);
            if (res == -1){
