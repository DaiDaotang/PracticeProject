...
import com.dao.ModifySchoolTeacherDao;
...
@WebServlet(name = "ModifySchoolTeacherServlet")
public class ModifySchoolTeacherServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ModifySchoolTeacherDao dao = new ModifySchoolTeacherDao();
