...
import com.dao.ModifyCompanyTeacherDao;
...
@WebServlet(name = "ModifyCompanyTeacherServlet")
public class ModifyCompanyTeacherServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ModifyCompanyTeacherDao dao = new ModifyCompanyTeacherDao();
            int res = dao.modify(reqBean);
            if (res == -1){
